...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a="feedback-form-state",r={form:document.querySelector(".feedback-form"),input:document.querySelector(".feedback-form input"),textarea:document.querySelector(".feedback-form textarea")};r.form.addEventListener("submit",u),r.form.addEventListener("input",(0,e.default)(n,500));let o={};function u(e){e.preventDefault(),console.log(o),e.currentTarget.reset(),localStorage.removeItem(a)}function n(e){o[e.target.name]=e.target.value,localStorage.setItem(a,JSON.stringify(o))}function l(){const e=localStorage.getItem(a),t=JSON.parse(e);t&&(r.input.value=t.email||"",r.textarea.value=t.message||"",o.email=r.input.value,o.message=r.textarea.value)}l();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.75a26598.js.map