...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r="feedback-form-state",a={form:document.querySelector(".feedback-form"),input:document.querySelector(".feedback-form input"),textarea:document.querySelector(".feedback-form textarea")};a.form.addEventListener("submit",n),a.form.addEventListener("input",(0,e.default)(u,500)),c();const o={};function n(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem(r),console.log(o)}function u(e){o[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(o))}function c(){const e=localStorage.getItem(r),t=JSON.parse(e);e&&(a.input.value=t.email,a.textarea.value=t.message)}
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.f44745d5.js.map